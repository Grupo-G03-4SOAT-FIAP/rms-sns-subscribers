...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=rms-sns-subscribers_cliente-criado-subscriber&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=rms-sns-subscribers_cliente-criado-subscriber)
...
|---------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| cliente-criado-subscriber | [![SAM Validate and Build](https://github.com/Grupo-G03-4SOAT-FIAP/rms-sns-subscribers/actions/workflows/sam-validate.yml/badge.svg)](https://github.com/Grupo-G03-4SOAT-FIAP/rms-sns-subscribers/actions/workflows/sam-validate.yml) | [![SAM Deploy](https://github.com/Grupo-G03-4SOAT-FIAP/rms-sns-subscribers/actions/workflows/sam-deploy.yml/badge.svg)](https://github.com/Grupo-G03-4SOAT-FIAP/rms-sns-subscribers/actions/workflows/sam-deploy.yml) |
